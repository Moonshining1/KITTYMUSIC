...
from KITTYMUSIC.utils.cleanmode import protected_messages
...
from KITTYMUSIC.utils.decorators.language import language
from KITTYMUSIC.utils.formatters import alpha_to_int
...
async def braodcast_message(client, message, _):
    ...
    if "-assistant" in message.text:
        ...
        text = _["broad_3"]
        from KITTYMUSIC.core.userbot import assistants
