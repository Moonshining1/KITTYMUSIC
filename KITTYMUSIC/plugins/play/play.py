#
# Copyright (C) 2024 by Moonshining1@Github, < https://github.com/THE-VIP-BOY-OP >.
#
...
from KITTYMUSIC import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
from KITTYMUSIC.core.call import KITTY
from KITTYMUSIC.utils import seconds_to_min, time_to_seconds
from KITTYMUSIC.utils.channelplay import get_channeplayCB
from KITTYMUSIC.utils.database import is_video_allowed
from KITTYMUSIC.utils.decorators.language import languageCB
from KITTYMUSIC.utils.decorators.play import PlayWrapper
from KITTYMUSIC.utils.formatters import formats
from KITTYMUSIC.utils.inline.play import (
    livestream_markup,
    playlist_markup,
    slider_markup,
    track_markup,
)
from KITTYMUSIC.utils.inline.playlist import botplaylist_markup
from KITTYMUSIC.utils.logger import play_logs
from KITTYMUSIC.utils.stream.stream import stream
...
@app.on_callback_query(filters.regex("KITTYPlaylists") & ~BANNED_USERS)
@languageCB
