...
from KITTYMUSIC import Carbon, app
from KITTYMUSIC.utils.decorators.language import language, languageCB
from KITTYMUSIC.utils.inline.playlist import (
    botplaylist_markup,
    get_playlist_markup,
    warning_markup,
)
...
from KITTYMUSIC.core.mongo import mongodb
...
async def add_playlist(client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from KITTYMUSIC import YouTube
...
@app.on_callback_query(filters.regex("KITTY_playlist") & ~BANNED_USERS)
@languageCB
